...
var instrucciones = ["Presioná las flechas", "Acomodá las fichas", "Disfrutá del juego"];
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  ...
  const temporal = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  console.log("fila pos inicial: " + filaPos1);
  console.log("col pos inicial: " + columnaPos1);
  grilla[filaPos2][columnaPos2] = temporal;
  console.log("fila pos final: " +filaPos2);
  console.log("col pos final: " + columnaPos2);
}
/* 
var primeraPosicion = grilla[filaPos1][columnaPos1];
console.log("ingreso 1ra posicion " + primeraPosicion);
var segundaPosicion = grilla[filaPos2][columnaPos2];
console.log("ingreso 2da posicion " + segundaPosicion);
var primeraPosicionTemporal = primeraPosicion;
var segundaPosicionTemporal = segundaPosicion;
primeraPosicion = segundaPosicionTemporal;
console.log("resultado 1ra posicion " + primeraPosicion);
segundaPosicion = primeraPosicionTemporal;
console.log("resultado 2da posicion " + segundaPosicion); */
